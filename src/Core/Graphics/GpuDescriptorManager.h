// GpuDescriptorManager.h — Descriptor Set 布局与分配管理
//
...
public:
    ...
    ~GpuDescriptorManager() = default;
    GpuDescriptorManager(const GpuDescriptorManager&) = delete;
    GpuDescriptorManager& operator=(const GpuDescriptorManager&) = delete;
